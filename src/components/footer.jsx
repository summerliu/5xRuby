        ...
        <div className="row">
          <div className="col-12 col-md-3">
            ...
            <a href="https://www.cakeresume.com/jobs" className="d-block cakeresume press-img" target="_blank" rel="noopener noreferrer">
              <img src="https://5xruby.tw/assets/images/footer/cakeresume-8938f367.png" title="CakeResume 找工作" alt="CakeResume 找工作" style={{ maxWidth: '180px', marginBottom: '10px', paddingRight: '6px' }} />
                ...
                <div className="row">
                  <div className="col-12 col-md-4 col-xl-3">
                    <div className="contact-info">
                      ...
                      <br />
                      <a href="https://www.facebook.com/5xruby" target="_blank" rel="noopener noreferrer"><i className="media-icon fab fa-facebook-f" /></a>
                      <a href="https://twitter.com/5xruby" target="_blank" rel="noopener noreferrer"><i className="media-icon fab fa-twitter" aria-hidden="true" /></a>
                      <a href="https://github.com/5xruby" target="_blank" rel="noopener noreferrer"><i className="media-icon fab fa-github" aria-hidden="true" /></a>
                    </div>
                  </div>
